...
def get_args():
    ...
    parser.add_argument('--contpermuted_beta', default=4, type=int,
                        help='Beta value for continuous permuted mnist. [default: 3]') #3

    parser.add_argument('--optimizer', type=str, default="bgd_new_update", choices=optimizers_names,
                        help='Optimizer.')
    ...
    parser.add_argument('--num_aggs_per_task', default=10, type=int,
